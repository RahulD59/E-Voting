...
<head>
  ...
  <link href="css/bsp.css" rel="stylesheet">
  ...
  <nav id="main-nav">
    <div class="row">
      <div class="container">
        ...
        <div class="logo">
          <a href="index.html"><img src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/201606/bsp---_146504296977_647x404_060416055635.jpg" alt="logo"></a>
        </div>
        ...
        <ul class="nav-menu list-unstyled">
          ...
          <li><a href="bspvoting.php" class="smoothScroll">To Vote</a></li>
        </ul>
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-4 ">
          <div class="div-img-bg">
            <div class="about-img">
              <img src="https://resize.indiatvnews.com/en/resize/newbucket/715_-/2017/12/mayawati-1512125437.jpg" class="img-responsive" alt="me">
            </div>
          </div>
        </div>
        <div class="container">
      <div class="header-content"><br><br><br><BR>
        <h1 style="color: black" >MAYAWATI</h1>
        ...
        <div class="col-lg-8">
          <div class="about-descr">
            ...
            <p class="p-heading">Former Chief Minister of Uttar Pradesh</p>
          ...
          <div class="portfolio-container">
            ...
            <div class="col-lg-4 col-md-6 portfolio-thumbnail all branding uikits webdesign">
              <a class="popup-img" href="images/portfolio/1.jpg">
                <img src="http://im.rediff.com/news/2018/may/23oppn2.jpg" alt="img">
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-thumbnail all mockups uikits photography">
              <a class="popup-img" href="images/portfolio/2.jpg">
                <img src="http://im.rediff.com/news/2018/aug/05mamata-mayawati.jpg"  alt="img">
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-thumbnail all branding webdesig photographyn">
              <a class="popup-img" href="images/portfolio/3.jpg">
                <img src=" https://img.etimg.com/thumb/height-480,width-640,msid-63581254,imgsize-28625/lucknow-bsp-president-mayawati-and-samajwadi-party-leader-ram-govind-chaudhary-.jpg  " alt="img">
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-thumbnail all branding uikits photography">
              <a class="popup-img" href="images/portfolio/5.jpg">
                <img src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/201901/23oppn13.jpeg?1XLP6T88_JoXj6zXFAjSwtj_2XHs2oy3" alt="img">
            ...
            <div class="col-lg-4 col-md-6 portfolio-thumbnail all mockups webdesign photography">
              <a class="popup-img" href="images/portfolio/4.jpg">
                <img src="https://www.thehindu.com/elections/karnataka-2018/article23675898.ece/alternates/FREE_660/26THNSMMAYA" alt="img">
              </a>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-thumbnail all mockups uikits webdesign">
              <a class="popup-img" href="images/protfolio/5.jpg" alt="img">
                 <img src="https://dc-cdn.s3-ap-southeast-1.amazonaws.com/dc-Cover-lcnolgidsp7tme074rsphntpo3-20160724031828.Medi.jpeg" alt="img">
              </a>
            </div>
