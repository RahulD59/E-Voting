...
<div class="card" style="width:800px align:center" >
    <img class="card-img-top" src="https://www.whoa.in/20150417-Whoa/Arvind-Kejriwal-AAP-Leaders-HD-Wallpaper.jpg" alt="Card image" style="width:70% ; margin-left:15.80%;">
    <div class="card-body">
      <h4 class="card-title" style="margin-left:40%;">AAM AADMI PARTY</h4>
      <p class="card-text" style=" margin-left:40%;"></p>
