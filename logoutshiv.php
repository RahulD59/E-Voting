...
$sql="INSERT into parties(bjp,congress,manse,shivsena,aap,bsp)values(NULL,NULL,NULL,'$email',NULL,NULL)";
mysqli_query($conn,$sql);
echo $_SESSION['username']."<h1> YOUR VOTE HAS BEEN GIVEN TO SHIVSENA. KINDLY LOGOUT<H1>";
